...
const ProviderBlock = () => {
    ...
    const unlink =async (providerId) => {
        ...
        try {
            if (auth.currentUser.providerData.length ===1) { throw new Error(`You cannont disconnect from ${providerId}`) }
